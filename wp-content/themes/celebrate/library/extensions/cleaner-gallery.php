...
function cleaner_gallery( $output, $attr ) {
	...
	$defaults = array(
		'order'       => 'ASC',
		'orderby'../../../celebrate/library/extensions/     => 'menu_order ID',
		'id'          => get_the_ID(),
		'mime_type'   => 'image',
		'link'        => '',
		'itemtag'../../../celebrate/library/extensions/     => 'figure',
		'icontag'../../../celebrate/library/extensions/     => 'div',
		'captiontag'  => 'figcaption',
		'columns'     => 3,
		'size'        => isset( $_wp_additional_image_sizes['post-thumbnail'] ) ? 'post-thumbnail' : 'thumbnail',
		'ids'         => '',
		'include'../../../celebrate/library/extensions/     => '',
		'exclude'     => '',
		'numberposts' => -1,
		'offset'      => ''
	);
