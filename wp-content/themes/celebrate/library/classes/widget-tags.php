...
class Hybrid_Widget_Tags extends WP_Widget {
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['include'../../../celebrate/library/classes/] = preg_replace( '/[^0-9,]/', '', $new_instance['include'] );
	...
	function form( $instance ) {
		...
		$defaults = array(
			...
			'order'                      => 'ASC',
			'orderby'../../../celebrate/library/classes/                    => 'name',
			'format'                     => 'flat',
			'include'../../../celebrate/library/classes/                    => '',
			'exclude'                    => '',
			'unit'                       => 'pt',
			'smallest'                   => 8,
			'largest'                    => 22,
