...
class Hybrid_Widget_Bookmarks extends WP_Widget {
	...
	function widget( $sidebar, $instance ) {
		...
		if ( !empty( $args['category'../../../celebrate/library/classes/] ) && is_array( $args['category'] ) )
			$args['category'] = join( ', ', $args['category'] );

		if ( !empty( $args['exclude_category'../../../celebrate/library/classes/] ) && is_array( $args['exclude_category'] ) )
			$args['exclude_category'] = join( ', ', $args['exclude_category'] );

		if ( !empty( $args['include'../../../celebrate/library/classes/] ) && is_array( $args['include'] ) )
			$args['include'../../../celebrate/library/classes/] = join( ',', $args['include'] );
