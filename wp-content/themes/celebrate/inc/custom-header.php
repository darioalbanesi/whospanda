...
function celebrate_header_style() {
	...
	<?php endif; ?>
		<?php 
		if ((celebrate_custom_header()->height > 350) && (!is_home())) {
			echo "#header {height: ".(celebrate_custom_header()->height/2)."px}";	
		} else {
			echo "#header {height: ".(celebrate_custom_header()->height)."px}";	
		}
		?>
	</style>
	<?php
